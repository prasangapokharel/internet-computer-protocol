...
import { idlFactory } from './portfolio.did.js';
export { idlFactory } from './portfolio.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PORTFOLIO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./portfolio.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the portfolio canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./portfolio.did.js")._SERVICE>}
 */
export const portfolio = createActor(canisterId);
